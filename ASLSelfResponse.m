function varargout = ASLSelfResponse(varargin)
% ASLSelfResponse MATLAB code for ASLSelfResponse.fig
%      ASLSelfResponse, by itself, creates a new ASLSelfResponse or raises the existing
%      singleton*.
%
%      H = ASLSelfResponse returns the handle to a new ASLSelfResponse or the handle to
%      the existing singleton*.
%
%      ASLSelfResponse('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ASLSelfResponse.M with the given input arguments.
%
%      ASLSelfResponse('Property','Value',...) creates a new ASLSelfResponse or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ASLSelfResponse_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ASLSelfResponse_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ASLSelfResponse

% Last Modified by GUIDE v2.5 04-Sep-2017 12:47:53

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ASLSelfResponse_OpeningFcn, ...
                   'gui_OutputFcn',  @ASLSelfResponse_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ASLSelfResponse is made visible.
function ASLSelfResponse_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ASLSelfResponse (see VARARGIN)

%                           1            2                       3                   4              5   6  7    8       9 
% function ASLSelfResponse(nKW,KeyWords{SentenceIndex},list(SentenceIndex),sentence(SentenceIndex),Fs,duty,y, trial, MaxTrials);   
...
% Choose default command line output for ASLSelfResponse
...
function varargout = ASLSelfResponse_OutputFcn(hObject, eventdata, handles) 
