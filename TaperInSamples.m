function s=TaperInSamples(wave, rise, fall, type)
%
% s=TaperInSample(wave, rise, fall, type)
%
% taper a given waveform, specifying rise and fall in number of samples
% null input wave leads to null output
% Put rises and falls onto a waveform 'wave'
% rise and fall times are specified independently in samples
% type - 'linear' or 'cosine' = raised cosine
%     DEFAULT: raised cosine
%
% modified from NewTaper.m July 2010
%
